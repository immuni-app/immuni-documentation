...
- _p<sub>T</sub>_(_i_), with _i_≥0, is the probability that the simulated TEK upload sequence continues, attempting to send a new request, after the (_i_+1)th request has been completed or has timed out.
